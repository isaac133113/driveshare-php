...
### Dashboard Principal
![Dashboard](https://via.placeholder.com/800x400/667eea/ffffff?text=Dashboard+DriveShare)

### Catálogo de Vehículos
![Vehicles](https://via.placeholder.com/800x400/28a745/ffffff?text=Catálogo+de+Vehículos)

### Mapa Interactivo
![Map](https://via.placeholder.com/800x400/17a2b8/ffffff?text=Mapa+Interactivo)
...
- Seguir los **estándares PSR-12** para PHP
...
**Isaac Bonet Olives**
- GitHub: [@isaac133113](https://github.com/isaac133113)
- Email: isaacbonetolives@mollerussa.lasalle.cat

## 🙏 Agradecimientos

- **La Salle Mollerussa** - Centro educativo
- **Bootstrap Team** - Framework CSS
- **PHPMailer Project** - Sistema de emails
