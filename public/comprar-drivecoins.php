...
<body style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 100vh;">
    ...
    require_once '../app/Models/DriveCoinModel.php';
    require_once '../app/Controllers/DriveCoinController.php';
    ...
    <div class="container py-5">
        ...
        <div class="text-center mt-4">
            <a href="../app/Views/horaris/dashboard.php" class="btn btn-outline-light rounded-3">
    ...
    <script>
        ...
        function processPurchase() {
            ...
            fetch('../app/Controllers/DriveCoinController.php', {
                method: 'POST',
                body: formData
            })
